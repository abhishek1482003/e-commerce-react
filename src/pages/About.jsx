...
const About = () => {
  ...
  <div className="stat">
    ...
    <p className='mt-6 text-lg leading-8 max-w-2xl mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed nihil eum sequi similique modi voluptate, recusandae nisi, placeat enim quidem ratione blanditiis. Nam, hic? Perspiciatis rerum assumenda consectetur! Est fugit vero libero modi aut in quas reiciendis id eius voluptatum.</p>
    </>
  )
}
